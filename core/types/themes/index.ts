...
export interface ThemeBorderElement {
...
export interface ThemeSpacingElement {
...
export interface ThemeFontElement {
  default?: ThemeFontPropertyElement
...
export interface ThemeBorderPropertyElement {
  border?: string
  radius?: {
    all?: string
    topRight?: string
...
export interface ThemeSpacingPropertyElement {
  padding?: {
    all?: string | number
    right?: string | number
    left?: string | number
...
export interface ThemeFontPropertyElement {
  fontSize?: string
  fontWeight?: string
