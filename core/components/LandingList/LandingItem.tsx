      ...
      <CardHeader
        ...
        action={
          <IconButton
            ...
            sx={{
              ...((themeCustomElements.button?.action?.primary) != null)
        ...
        >
          <Box>
            <Typography
              ...
              mb={1}
              sx={{
                ...((themeCustomElements.landingList?.nameText) != null)
                  ? convertElementToSx(themeCustomElements.landingList.nameText)
                  : undefined,
                wordWrap: 'break-word'
              }}
            >
