...
interface ManagePInventoryFormProps {
...
const ManagePInventoryForm = (props: ManagePInventoryFormProps) => {
  ...
  const handleSubmit = async (values: ProductInventory) => {
    if (action === ManageActions.create) {
      ...
      void manageProductInventory(action, values, onSubmitSuccess)
    }
  }

  const handleDeleteBtn = () => {
    if (productInventory != null) {
      void manageProductInventory(ManageActions.delete, productInventory, onDeleteSuccess)
    }
  }
    ...
    <BaseForm
      ...
      formFieldGroups={[
        {
          titleTxt: {
            id: action === ManageActions.create
              ? 'forms.createInventory.title'
              : 'forms.updateInventory.title'
          },
          formFields: [
            {
              name: 'sku',
      ...
      formButtons={{
        submit: {
          text: {
            id: action === ManageActions.create
              ? 'forms.createInventory.successBtn'
              : 'forms.updateInventory.successBtn'
          },
