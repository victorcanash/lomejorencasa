...
const VacuumBanner = () => {
  ...
  const getSxContent = useCallback(() => {
    if (smallBreakpoint) {
      return ((themeCustomElements.banners?.product?.small) != null)
        ? convertElementToSx(themeCustomElements.banners.product.small)
        : undefined
    }
    return ((themeCustomElements.banners?.product?.default) != null)
      ? convertElementToSx(themeCustomElements.banners.product.default)
      : undefined
  }, [smallBreakpoint])
